...
<%  } %>
<div id="zawartosc">
<form method="post" action="kluby_edytuj_a.jsp">
            <center>
            <table border="0" width="40%" cellpadding="5">
                ...
                <tbody>
                    <tr>
                        <td>Nazwa klubu</td>
                        <td><input type="text" name="nklubu" value="" required="required" /></td>
                    </tr>
                    <tr>
                        <td>Miasto</td>
                        <td><input type="text" name="miasto" value="" required="required" /></td>
                    </tr>
                   <td></td>
