...
<div id="zawartosc">
            ...
            <%
                ...
                String nklubu = request.getParameter("nklubu");    
                ...
                ResultSet rs;
                rs = stat.executeQuery("select * from ZAWODNICY join KLUBY on ZAWODNICY.ID_KLUBU=KLUBY.ID_KLUBU where NAZWA_KLUBU='" + nklubu + "' and MIASTO='" + miasto + "'");
                      
                if(rs.next()){
                out.println("<g>" + "Lista obejmująca wszystkich obecnych i byłych zawodników klubu " + rs.getString("NAZWA_KLUBU")+ " "
                        + "" + rs.getString("MIASTO") +"</g>");
                %>
                <table rules="all" width="90%" align="center" cellpadding="3"  bgcolor="#cdcdcd" bordercolor="#F3F3F3">
            <thead>
                <tr>
                    <th>Imie</th>
                    <th>Nazwisko</th>
                ...
                out.println("Nie ma takiego klubu lub zawodników w klubie <a href='zawodnicy_ciekaw.jsp'><font color='black'>Spróbuj ponownie</font></a></br></br> "
                + "<img src='blad.png' width='300' />");}
                
                ResultSet rs1 = stat.executeQuery("select * from ZAWODNICY join KLUBY on ZAWODNICY.ID_KLUBU=KLUBY.ID_KLUBU where NAZWA_KLUBU='" + nklubu + "' and MIASTO='" + miasto + "'");
                while (rs1.next()) {
                    out.println("<tr>");
