...
<html>
    <head>
        ...
        <script src="stadiony.js" language=javascript type="text/javascript"></script>
...
<div id="zawartosc">
   <%
    ...
    ResultSet rs;
    rs = sta.executeQuery("select * from STADION where ADRES='" + adres + "'");
    if (rs.next()) {
        %>
       <form method="post" action="stadiony_zapisz.jsp?ID_S=<%=rs.getString("ID_STADION")%>" onsubmit='return validation()'> 
<center>
            <table border="0" width="40%" cellpadding="5">
                <thead>
                    <tr>
                        <th colspan="2">Edytuj dane stadionu</th>
                    </tr>
                </thead>
                <tbody>
    <tr>
        <td>
                Adres </td>
                <td ><%=rs.getString("ID_STADION")%></td>
    </tr>
    
    <tr>
        <td>
                Adres </td>
                <td><input type="text" name="adres" id="adres" value="<%=rs.getString("ADRES")%>" required="required"></td>
    </tr>
    
    <tr>
        <td>
                Miejsca siedzące</td>
                <td><input type="text" name="msiedzace" id="msiedzace" maxlength="5" value="<%=rs.getString("MIEJSC_SDZ")%>" required="required"></td>
    </tr>
    
    <tr>
        <td>
                Miejsca stojące </td>
                <td><input type="text" name="mstojace" id="mstojace" maxlength="5" value="<%=rs.getString("MIEJSC_ST")%>" required="required"></td>
    </tr>
    <td></td>
    <td><input type="submit" value="Zapisz"></td>
        ...
        out.println("Nie ma takiego stadionu <a href='stadiony_edytuj.jsp'><font color='black'>Spróbuj ponownie</font></a></br></br> "
