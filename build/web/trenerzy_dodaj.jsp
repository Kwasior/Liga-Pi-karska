...
<%  } %>
<div id="zawartosc">
   <form method="post" action="trenerzy_dodaj_a.jsp" onsubmit='return validation()'>
            <center>
            <table border="0" width="40%" cellpadding="5">
                <thead>
                    <tr>
                        <th colspan="2">Dodaj trenera</th>
                    </tr>
                </thead>
                <tbody>
                    <tr>
                    ...
                    <tr>
                        <td>Data wygaśnięcia kontraktu</td>
                        <td><input type="date" name="kont_wyg" id="kont_wyg" value="" required="required" /></td>
                    </tr>
                    <tr>
                        <td></td>
