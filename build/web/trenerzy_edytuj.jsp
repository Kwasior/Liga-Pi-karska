...
<%  } %>
<div id="zawartosc">
   <form method="post" action="trenerzy_edytuj_a.jsp">
            <center>
            <table border="0" width="40%" cellpadding="5">
                ...
                <tbody>
                    <tr>
                        <td>Imię trenera</td>
                        <td><input type="text" name="imie" value="" required="required" /></td>
                    </tr>
                    <tr>
                        <td>Nazwisko trenera</td>
                        <td><input type="text" name="nazwisko" value="" required="required" /></td>
                    </tr>
                   <td></td>
                        <td><input type="submit" value="Znajdź" />
