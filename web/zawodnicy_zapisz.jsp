...
<%
    ...
    String sid = request.getParameter("ID_Z");   
    ...
    //ResultSet rs;
    int i = sta.executeUpdate("UPDATE ZAWODNICY " + "SET IMIĘ = '"+ name + "' " + ", NAZWISKO = '"+ sname + "' " + ", DATA_UR = '"+ sdate + "' " + ", MIEJ_UR = '"+ smiej + "' " + ", KRAJ = '"+ skraj + "' " + ", WYSTĘPY = '"+ swyst + "' " + ", GOLE = '"+ sgole + "' " + ", POZYCJA = '"+ spozy + "' " + ", ID_KLUBU = '"+ sid_k + "' " + " WHERE ID_ZAWODNIKA = '" + sid + "'");
    if (i > 0) {
        out.print("Dane zmieniono pomyślnie </br></br> <img src='zawodnik.png' width='300' />");
    } else {
        out.println("Błędne dane <a href='zawodnicy_edytuj.jsp'>Spróbuj ponownie</a>");
    }
    conn1.close();
%>    
</div>
