...
<%
                ...
                ResultSet rs = stat.executeQuery("select * from TRENERZY;");
                      
                if(rs.next()){
                out.println("<g>" + "Lista obejmująca wszystkich obecnych i byłych trenerów zespołów EKSTRAKLASY" + "</g>");
                %>
                <table rules="all" width="90%" cellpadding="3" align="center" bgcolor="#cdcdcd" bordercolor="#F3F3F3">
            <thead>
                <tr>
                    <th>ID Trenera</th>
                    <th>Imię</th>
                ...
                out.println("Nie ma obecnie żadnych trenerów w bazie </br></br> "
                + "<img src='blad.png' width='300' />");}
                
               ResultSet rs1 = stat.executeQuery("select * from TRENERZY;");
                while (rs1.next()) {
                    out.println("<tr>");
