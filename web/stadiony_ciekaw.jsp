...
<%  } %>
<div id="zawartosc">
  <g>Wyszukaj nazwy klubów które posiadają stadiony o pojemności większej niż:</g>
<form method="post" action="stadiony_ciekaw_a.jsp">
            <center>
            <table border="0" width="20%" cellpadding="5">
                <tbody>
                <tr>  
                    <td colspan="2" align="center"><input type="text" name="msiedzace" value="" required="required" size="10" /></td>
                    </tr>
                <tr><td colspan="2" align="center"><z>Ilość miejsc</td></tr>
