...
<%
    ...
    String sidt = request.getParameter("ID_T");   
    ...
    String skont = request.getParameter("kont_wyg");
    ...
    //ResultSet rs;
    int i = sta.executeUpdate("UPDATE TRENERZY " + "SET IMIĘ = '"+ name + "' " + ", NAZWISKO = '"+ sname + "' " + ", DATA_UR = '"+ sdate + "' " + ", KRAJ = '"+ skraj + "' " + ", KONT_WYG = '"+ skont + "' " + " WHERE ID_TRENERA = '" + sidt + "'");
    if (i > 0) {
        out.print("Dane zmieniono pomyślnie </br></br> <img src='zawodnik.png' width='300' />");
    } else {
        out.println("Błędne dane <a href='trenerzy_edytuj.jsp'>Spróbuj ponownie</a>");
    }
    conn1.close();
%>    
</div>
