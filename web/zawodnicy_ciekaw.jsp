...
<%  } %>
<div id="zawartosc">
    <g>Wyszukaj zawodników klubu:</g>
<form method="post" action="zawodnicy_ciekaw_a.jsp">
            <center>
            <table border="0" width="20%" cellpadding="5">
                <tbody>
                <tr>  
                    <td><input type="text" name="nklubu" value="" required="required" size="10" /></td>
                    <td><input type="text" name="miasto" value="" required="required" size="10" /></td>
                </tr>
                <tr><td><z><center>Nazwa klubu</center></z></td><td><z><center>Miasto</center></z></td></tr>
