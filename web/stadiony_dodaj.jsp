...
<%  } %>
<div id="zawartosc">
   <form method="post" action="stadiony_dodaj_a.jsp" onsubmit='return validation()'>
            <center>
            <table border="0" width="40%" cellpadding="5">
                <thead>
                    <tr>
                        <th colspan="2">Dodaj stadion</th>
                    </tr>
                </thead>
                <tbody>
                    <tr>
                        <td>Adres</td>
                        <td><input type="text" name="adres" id="adres" value="" required="required" /></td>
                    </tr>
                    <tr>
                        <td>Miejsca siedżące</td>
                        <td><input type="text" name="msiedzace" id="msiedzace" maxlength="5" value="" required="required" /></td>
                    </tr>
                    <tr>
                        <td>Miejsca stojące</td>
                        <td><input type="text" name="mstojace" id="mstojace" maxlength="5" value="" required="required" /></td>
                    </tr>
                    <tr>
                        <td></td>
