...
<%  } %>
<div id="zawartosc">
   <g>Wyszukaj trenerów trenujących zespoły z miasta:</g>
<form method="post" action="trenerzy_ciekaw_a.jsp">
            <center>
            <table border="0" width="20%" cellpadding="5">
                <tbody>
                <tr>  
                    <td colspan="2" align="center"><input type="text" name="miasto" value="" required="required" size="10" /></td>
                    </tr>
                <tr><td colspan="2" align="center"><z>Miasto</td></tr>
